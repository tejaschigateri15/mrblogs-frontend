...
export default function UseProfile() {
  ...
  return (
    ...
    <div className="profile-main">
      ...
      <div className="profilecardc shadow-md">
        <div className="profileitemsc">
          ...
          <div className="profileinfoc">
            ...
            <div className="profilebio"> <p>{fetchedbio || <p>User Bio </p>}</p></div>
